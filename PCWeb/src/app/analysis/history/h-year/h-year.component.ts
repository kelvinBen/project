...
import { CimissResult, CimissHYear } from '../../../models/cimiss';
...
export class HYearComponent implements OnInit {
  ...
  queryHyear() {
    ...
    sUrl += 'interfaceId=getSurfMYerEleByStaID&dataCode=SURF_CHN_YER_MMUT_19812010&dataFormat=json&staIds=57132&';
    ...
    this._http.get(sUrl).subscribe(result => {
      ...
      if (cimissDt && cimissDt.returnCode === '0') {
        this.yearDatas = cimissDt.DS as CimissHYear[];
        this.yearData = this.yearDatas[0];
      }
    });
  }
}

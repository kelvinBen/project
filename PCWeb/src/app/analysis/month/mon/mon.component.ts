...
import { CimissResult, CimissDay, CimissDayMMUT19812010, CimissMonth } from '../../../models/cimiss';
...
export class MonComponent implements OnInit {
  ...
  selUrl: String = '';
  sDate: Date = moment().add(-13, 'months').toDate();
  eDate: Date = moment().add(-1, 'months').toDate();
  ...
  queryMon() {
    ...
    sUrl += 'interfaceId=getSurfEleByTimeRangeAndStaID&dataCode=SURF_CHN_MUL_MON&dataFormat=json&staIds=57132&';

function InitTDTVecLayer(type) {
    dojo.declare("TDTVecMapServiceLayer", esri.layers.TiledMapServiceLayer, {
        ...
        //},
        getTileUrl: function (level, row, col) {
            return 'http://t' + col % 8 + '.tianditu.cn/DataServer?T=vec_c&X=' + col + '&Y=' + row + '&L=' + level;
        }
    });
}
function InitGoogleLayer(type) {
    dojo.declare("my.PortlandTiledMapServiceLayer",
        esri.layers.TiledMapServiceLayer, {
            constructor: function () {
                this.MapStyle = (type == null) ? "Vector" : type;
                this.spatialReference = new esri.SpatialReference({ wkid: 102113 });
                this.initialExtent = (this.fullExtent = new esri.geometry.Extent(-20037508.342787,
            ...
            getTileUrl: function (level, row, col) {
                ...
                {
                    //var url= "http://mt" + (col % 4) + ".google.cn/vt/lyrs=m@226000000&hl=zh-CN&gl=cn&src=app&" + "x=" + col + "&" +"y=" +row +"&" +"z=" +level +"&s=Gali";
                    var url = "http://mt3.google.cn/vt/lyrs=" + "s" + "&hl=zh-CN&gl=CN&" + "x=" + col + "&" + "y=" + row + "&" + "z=" + level;
                    //var url = "http://mt1.google.cn/vt/lyrs=" + "t@131" + "&hl=zh-CN&gl=CN&src=app&" + "x=" + col + "&" + "y=" + row + "&" + "z=" + level + "&s=Ga";
                    //var url = "http://mt" + (col % 4) + ".google.cn/vt/lyrs=t@131,r@227000000&hl=zh-CN&gl=cn&s=Gali";
                    //var url = "http://mt2.google.cn/vt/lyrs=" + "m" + "&hl=en&gl=CN&" + "x=" + col + "&" + "y=" + row + "&" + "z=" + level;
                }
                return url;  
            }
        });

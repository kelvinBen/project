 ...
 */
angular.module('app.DangerResourceMgr',[]);
var curApp = angular.module('app.DangerResourceMgr');
curApp.controller('DangerResourceMgrCtrl',function ($resource,$scope,$timeout,$state) {
    var vm = this;
    activate();
    function activate() {

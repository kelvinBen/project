 ...
 */
angular.module('app.InternationalMgr',[]);
var curApp = angular.module('app.InternationalMgr');
curApp.controller('InternationalMgrCtrl',function ($resource,$scope,$timeout,$state) {
    var vm = this;
    activate();
    function activate() {

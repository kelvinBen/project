/**
 * Created by ym on 2016/7/7.
 */
'use strict';

angular.module('myApp.systemguide', ['angularBootstrapNavTree'])
    .controller('navtreeController', navtreeController);

navtreeController.$inject = ['$scope', '$resource', '$timeout'];
function navtreeController($scope ,$resource, $timeout) {
    var vm = this;
    ...
    function activate() {
        ...
        vm.try_async_load = function() {
            ...
            // var remoteTree = $resource('treedata.json');
